  ...
  return {
    ...
    html: `
      <div style="font-family:'Montserrat',Arial,sans-serif;max-width:600px;margin:0 auto;color:#555;">
        ...
        <div style="padding:32px;border:1px solid #e8e2d9;border-top:none;">
          <h2 style="color:#1a1a1a;font-family:'Playfair Display',Georgia,serif;">Mesajınız Alındı</h2>
          <p>Sayın ${escapeHtml(data.name)},</p>
          <p>Bize ulaştığınız için teşekkür ederiz. Mesajınız tarafımıza ulaşmıştır ve en geç 24 saat içinde size dönüş yapacağız.</p>
          <p>Acil bir konu için doğrudan bizi arayabilirsiniz:</p>
